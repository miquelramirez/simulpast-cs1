...
HunterGatherer::HunterGatherer( const std::string & id ) : GujaratAgent(id), _surplusForReproductionThreshold(20), _surplusWanted(5)
{
}
...
void HunterGatherer::evaluateIntraSeasonalActions()
{
	...
	while(failedAllocations < 3 && planTime < _availableTime && _collectedResources < (_surplusForReproductionThreshold + _surplusWanted))

...
def main() :
	...
	for log, title_str in inputs :
		...
		plt.plot( [i for i in range(0,len(agents),120) ], [ agents[i] for i in range(0,len(agents),120) ], label=title_str+", agents" )
		plt.plot( [i for i in range(0,len(agents),120) ], [ adults[i] for i in range(0,len(adults),120) ], label=title_str+", adults" )
		plt.plot( [i for i in range(0,len(agents),120) ], [ children[i] for i in range(0,len(children),120) ], label=title_str+", children" )
